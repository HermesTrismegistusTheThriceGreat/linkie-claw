...
- Start looking for Architecture docs rules files such as CLAUDE.md, AGENTS.md, or similar documentation
- Continue with root-level config files (package.json, tsconfig.json, etc.)
...
- Check docs/ for curated documentation
